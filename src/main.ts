import { App, Modal, Notice, Plugin, TFile, TFolder, moment } from "obsidian";
    ...
    new TextInputModal(
      ...
      async (instruction) => {
        ...
        try {
          ...
          new ConfirmModal(
            this.app,
            "Aperçu disponible dans la console. Remplacer le contenu de la note ?",
...
class ResultatsModal extends Modal {
  private titre: string;
